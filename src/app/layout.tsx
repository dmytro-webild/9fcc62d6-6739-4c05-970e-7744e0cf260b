...
export const metadata: Metadata = {
  title: "Rendoras Heated Blanket | USB-Powered Wearable Warmth",  description: "Stay cozy with Rendoras heated blanket. Lightweight, wearable, USB-powered with adjustable heat. Perfect for home, office, or travel. Order now!",  keywords: "heated blanket, wearable blanket, USB heated blanket, cozy blanket, office warmth, travel blanket, cold sensitive",  metadataBase: new URL("https://rendoras.com"),
  alternates: {
    canonical: "https://rendoras.com"},
  openGraph: {
    title: "Rendoras Heated Blanket | Ultimate Cozy Comfort",    description: "Experience warmth like never before with our portable USB-powered heated blanket. Lightweight, adjustable, and perfect for your lifestyle.",    url: "https://rendoras.com",    siteName: "Rendoras",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/woman-holding-cup-coffee-while-being-covered-with-blanket_23-2148821621.jpg",        alt: "Rendoras heated blanket wearable hoodie"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "Rendoras Heated Blanket | Stay Warm. Stay Cozy.",    description: "The perfect wearable heated blanket for cold-sensitive people. USB-powered, adjustable heat, lightweight & portable.",    images: ["http://img.b2bpic.net/free-photo/woman-holding-cup-coffee-while-being-covered-with-blanket_23-2148821621.jpg"],
  },
  robots: {
    index: true,
    follow: true,
